...
public class DanhSachYeuCauAdminView extends JPanel {
	...
	public DanhSachYeuCauAdminView() {		
		...
		for (YeuCauMuonTra yc : dSYeuCau) {
			Object[] row = new Object[] {yc.getMaYeuCau(),yc.getSach().getTenSach(),yc.getHinhThucMuon(),yc.getThoiGianYeuCau(),yc.getHoTen(),yc.getEmail(),yc.getSoDienThoai(),yc.getTinhTrang()};
