...
public class KhoSachNDView extends JPanel {
	...
	public KhoSachNDView(TaiKhoan taiKhoan) {
		...
		JMenuItem item_Muon = new JMenuItem("Mượn");
	...
	public void bookDetail() {
		...
		String selectedTenSach = tbl_dSSach.getValueAt(selectedRow, 0).toString();
		Sach s = new Sach();
		s.setTenSach(selectedTenSach);
		s = SachDAO.getInstance().searchByName(s);
