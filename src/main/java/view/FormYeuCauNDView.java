...
public class FormYeuCauNDView extends JFrame {
...
//	}
	 ...
	 * Create the frame.
	 */
	public FormYeuCauNDView(Sach s, TaiKhoan tk) {
		this.s = s;
		this.tk = tk;
...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		tf_SDT = new JTextField(tk.getSoDienThoai());
	...
	private void makeRequest() {
		...
		if (tf_HoTen.getText().equals("") || tf_Email.getText().equals("") || tf_SDT.getText().equals("")) {
			...
			YeuCauMuonTraDAO.getInstance().insertByTaiKhoan(yc);
			JOptionPane.showMessageDialog(contentPane, "Tạo yêu cầu thành công");
			setVisible(false);
		}
